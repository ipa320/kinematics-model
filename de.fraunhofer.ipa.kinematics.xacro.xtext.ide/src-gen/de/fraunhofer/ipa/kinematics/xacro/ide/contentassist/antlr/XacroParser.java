...
public class XacroParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XacroGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRobotAccess().getMacroAssignment_5_2(), "rule__Robot__MacroAssignment_5_2");
			builder.put(grammarAccess.getRobotAccess().getMacroAssignment_5_3_1(), "rule__Robot__MacroAssignment_5_3_1");
