...
public class InternalXacroLexer extends Lexer {
    ...
    public final void mT__28() throws RecognitionException {
        try {
            int _type = T__28;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:23:7: ( 'type' )
            // InternalXacro.g:23:9: 'type'
            {
            match("type"); 
    ...
    public final void mT__30() throws RecognitionException {
        try {
            int _type = T__30;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:25:7: ( 'String' )
            // InternalXacro.g:25:9: 'String'
            {
            match("String"); 
    ...
    public final void mT__31() throws RecognitionException {
        try {
            int _type = T__31;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:26:7: ( 'LinkRef' )
            // InternalXacro.g:26:9: 'LinkRef'
            {
            match("LinkRef"); 
    ...
    public final void mT__32() throws RecognitionException {
        try {
            int _type = T__32;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:27:7: ( 'Pose' )
            // InternalXacro.g:27:9: 'Pose'
            {
            match("Pose"); 
    ...
    public final void mT__33() throws RecognitionException {
        try {
            int _type = T__33;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:28:7: ( 'Body' )
            // InternalXacro.g:28:9: 'Body'
            {
            match("Body"); 
    ...
    public final void mT__34() throws RecognitionException {
        try {
            int _type = T__34;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:29:7: ( 'link' )
            // InternalXacro.g:29:9: 'link'
            {
            match("link"); 
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalXacro.g:9417:21: ( '0' .. '9' )
            // InternalXacro.g:9417:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9419:14: ( ( 'true' | 'false' ) )
            // InternalXacro.g:9419:16: ( 'true' | 'false' )
            {
            // InternalXacro.g:9419:16: ( 'true' | 'false' )
            int alt1=2;
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9421:13: ( RULE_DECINT ( '.' ( RULE_DIGIT )* | ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT ) )
            // InternalXacro.g:9421:15: RULE_DECINT ( '.' ( RULE_DIGIT )* | ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT )
            {
            mRULE_DECINT(); 
            // InternalXacro.g:9421:27: ( '.' ( RULE_DIGIT )* | ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT )
            int alt6=2;
            alt6 = dfa6.predict(input);
            switch (alt6) {
                case 1 :
                    // InternalXacro.g:9421:28: '.' ( RULE_DIGIT )*
                    {
                    match('.'); 
                    // InternalXacro.g:9421:32: ( RULE_DIGIT )*
                    loop2:
                    do {
                        int alt2=2;
                    ...
                    break;
                case 2 :
                    // InternalXacro.g:9421:44: ( '.' ( RULE_DIGIT )* )? ( 'E' | 'e' ) ( '-' | '+' )? RULE_DECINT
                    {
                    // InternalXacro.g:9421:44: ( '.' ( RULE_DIGIT )* )?
                    int alt4=2;
                    ...
                    switch (alt4) {
                        case 1 :
                            // InternalXacro.g:9421:45: '.' ( RULE_DIGIT )*
                            {
                            match('.'); 
                            // InternalXacro.g:9421:49: ( RULE_DIGIT )*
                            loop3:
                            do {
                                int alt3=2;
    ...
    public final void mRULE_DECINT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9423:13: ( ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '0' .. '9' ( RULE_DIGIT )* ) )
            // InternalXacro.g:9423:15: ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '0' .. '9' ( RULE_DIGIT )* )
            {
            // InternalXacro.g:9423:15: ( '0' | '1' .. '9' ( RULE_DIGIT )* | '-' '0' .. '9' ( RULE_DIGIT )* )
            int alt9=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt9) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalXacro.g:9423:20: '1' .. '9' ( RULE_DIGIT )*
                    {
                    matchRange('1','9'); 
                    // InternalXacro.g:9423:29: ( RULE_DIGIT )*
                    loop7:
                    do {
                        int alt7=2;
                    ...
                    break;
                case 3 :
                    // InternalXacro.g:9423:41: '-' '0' .. '9' ( RULE_DIGIT )*
                    {
                    match('-'); 
                    matchRange('0','9'); 
                    // InternalXacro.g:9423:54: ( RULE_DIGIT )*
                    loop8:
                    do {
                        int alt8=2;
    ...
    public final void mRULE_JOINTTYPE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9425:16: ( ( 'revolute' | 'continuous' | 'prismatic' | 'fixed' | 'floating' | 'planar' ) )
            // InternalXacro.g:9425:18: ( 'revolute' | 'continuous' | 'prismatic' | 'fixed' | 'floating' | 'planar' )
            {
            // InternalXacro.g:9425:18: ( 'revolute' | 'continuous' | 'prismatic' | 'fixed' | 'floating' | 'planar' )
            int alt10=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt10) {
                case 1 :
                    // InternalXacro.g:9425:19: 'revolute'
                    {
                    match("revolute"); 
                    ...
                    break;
                case 2 :
                    // InternalXacro.g:9425:30: 'continuous'
                    {
                    match("continuous"); 
                    ...
                    break;
                case 3 :
                    // InternalXacro.g:9425:43: 'prismatic'
                    {
                    match("prismatic"); 
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // InternalXacro.g:9425:63: 'floating'
                    {
                    match("floating"); 
                    ...
                    break;
                case 6 :
                    // InternalXacro.g:9425:74: 'planar'
                    {
                    match("planar"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9427:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalXacro.g:9427:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalXacro.g:9427:11: ( '^' )?
            int alt11=2;
            ...
            // InternalXacro.g:9427:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9429:10: ( ( '0' .. '9' )+ )
            // InternalXacro.g:9429:12: ( '0' .. '9' )+
            {
            // InternalXacro.g:9429:12: ( '0' .. '9' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9431:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalXacro.g:9431:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalXacro.g:9431:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // InternalXacro.g:9431:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalXacro.g:9431:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop14:
                    do {
                        int alt14=3;
                    ...
                    break;
                case 2 :
                    // InternalXacro.g:9431:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalXacro.g:9431:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop15:
                    do {
                        int alt15=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9433:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalXacro.g:9433:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalXacro.g:9433:24: ( options {greedy=false; } : . )*
            loop17:
            do {
                int alt17=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9435:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalXacro.g:9435:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalXacro.g:9435:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9437:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalXacro.g:9437:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalXacro.g:9437:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt21=0;
            loop21:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalXacro.g:9439:16: ( . )
            // InternalXacro.g:9439:18: .
            {
            matchAny(); 
