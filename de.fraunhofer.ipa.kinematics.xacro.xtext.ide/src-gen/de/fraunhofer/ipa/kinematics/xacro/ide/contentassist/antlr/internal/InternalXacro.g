...
:
	(
		...
		(
			{ before(grammarAccess.getMacroCallAccess().getMacroMacroEStringParserRuleCall_4_0_1()); }
			ruleEString
			{ after(grammarAccess.getMacroCallAccess().getMacroMacroEStringParserRuleCall_4_0_1()); }
		)
