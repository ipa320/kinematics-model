 ...
 * </p>
 * <ul>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getA <em>A</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getB <em>B</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getGearRatio <em>Gear Ratio</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getH <em>H</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getL0 <em>L0</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getMechanicalReduction <em>Mechanical Reduction</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getName <em>Name</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getPhi0 <em>Phi0</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getR <em>R</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getScrewReduction <em>Screw Reduction</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getT0 <em>T0</em>}</li>
 *   <li>{@link urdf.impl.GapJointTransmissionImpl#getTheta0 <em>Theta0</em>}</li>
 * </ul>
 *
 * @generated
 */
