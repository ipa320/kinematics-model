...
public class KinematicsAdapterFactory extends AdapterFactoryImpl {
	...
	protected KinematicsSwitch<Adapter> modelSwitch =
		new KinematicsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseref_robot(ref_robot object) {
				return createref_robotAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link kinematics.ref_robot <em>ref robot</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
