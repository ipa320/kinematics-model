 ...
 * </p>
 * <ul>
 *   <li>{@link xacro.impl.ParameterValueImpl#getRef <em>Ref</em>}</li>
...
public class ParameterValueImpl extends MinimalEObjectImpl.Container implements ParameterValue {
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XacroPackage.PARAMETER_VALUE__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(Parameter newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XacroPackage.PARAMETER_VALUE__REF, oldRef, ref));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XacroPackage.PARAMETER_VALUE__REF:
