...
public class XacroAdapterFactory extends AdapterFactoryImpl {
	...
	protected XacroSwitch<Adapter> modelSwitch =
		new XacroSwitch<Adapter>() {
			...
			@Override
			public Adapter caseConfiguredMacro(ConfiguredMacro object) {
				return createConfiguredMacroAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseXacroRobot(XacroRobot object) {
				return createXacroRobotAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link xacro.ConfiguredMacro <em>Configured Macro</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link xacro.ConfiguredParameter <em>Configured Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link xacro.XacroRobot <em>Robot</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
