...
public class XacroSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case XacroPackage.CONFIGURED_MACRO: {
				ConfiguredMacro configuredMacro = (ConfiguredMacro)theEObject;
				T result = caseConfiguredMacro(configuredMacro);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XacroPackage.CONFIGURED_PARAMETER: {
			...
			case XacroPackage.XACRO_ROBOT: {
				XacroRobot xacroRobot = (XacroRobot)theEObject;
				T result = caseXacroRobot(xacroRobot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Configured Macro</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Configured Macro</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConfiguredMacro(ConfiguredMacro object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseXacroRobot(XacroRobot object) {
		return null;
	}
