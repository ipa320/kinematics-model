...
public class KinematicsPackageImpl extends EPackageImpl implements KinematicsPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getrobot_Root_link(), this.getlink(), null, "root_link", null, 1, 1, robot.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
