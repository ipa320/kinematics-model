...
public class KinematicsSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == KinematicsPackage.eINSTANCE)
			...
			case KinematicsPackage.ROBOT:
				sequence_Kinematics(context, (robot) semanticObject); 
				return; 
			}
	 ...
	 *
	 * Constraint:
	 *     (name=EString root_link=link joints+=joint*)
	 */
	protected void sequence_Kinematics(ISerializationContext context, robot semanticObject) {
