...
/**
 * This is the item provider adapter for a {@link urdf.Material} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MaterialItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UrdfPackage.Literals.MATERIAL__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UrdfPackage.Literals.MATERIAL__COLOR);
			childrenFeatures.add(UrdfPackage.Literals.MATERIAL__TEXTURE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UrdfPackage.Literals.MATERIAL__COLOR,
				 UrdfFactory.eINSTANCE.createColor()));

		newChildDescriptors.add
			(createChildParameter
				(UrdfPackage.Literals.MATERIAL__TEXTURE,
