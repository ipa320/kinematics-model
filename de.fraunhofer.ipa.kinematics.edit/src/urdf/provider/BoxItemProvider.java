...
/**
 * This is the item provider adapter for a {@link urdf.Box} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoxItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Box_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Box_size_feature", "_UI_Box_type"),
				 UrdfPackage.Literals.BOX__SIZE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Box)object).getSize();
