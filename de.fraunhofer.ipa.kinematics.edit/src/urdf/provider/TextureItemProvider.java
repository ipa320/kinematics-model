...
/**
 * This is the item provider adapter for a {@link urdf.Texture} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextureItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Texture_filename_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Texture_filename_feature", "_UI_Texture_type"),
				 UrdfPackage.Literals.TEXTURE__FILENAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Texture)object).getFilename();
