...
public class UrdfItemProviderAdapterFactory extends UrdfAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link urdf.RobotType} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected RobotTypeItemProvider robotTypeItemProvider;

	/**
	 * This creates an adapter for a {@link urdf.RobotType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createRobotTypeAdapter() {
		if (robotTypeItemProvider == null) {
			robotTypeItemProvider = new RobotTypeItemProvider(this);
		}

		return robotTypeItemProvider;
	}
	...
	public void dispose() {
		...
		if (robotTypeItemProvider != null) robotTypeItemProvider.dispose();
