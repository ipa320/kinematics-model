...
/**
 * This is the item provider adapter for a {@link urdf.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UrdfPackage.Literals.LINK__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UrdfPackage.Literals.LINK__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UrdfPackage.Literals.LINK__INERTIAL);
			childrenFeatures.add(UrdfPackage.Literals.LINK__VISUAL);
			childrenFeatures.add(UrdfPackage.Literals.LINK__COLLISION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UrdfPackage.Literals.LINK__INERTIAL,
				 UrdfFactory.eINSTANCE.createInertial()));

		newChildDescriptors.add
			(createChildParameter
				(UrdfPackage.Literals.LINK__VISUAL,
				 UrdfFactory.eINSTANCE.createVisual()));

		newChildDescriptors.add
			(createChildParameter
				(UrdfPackage.Literals.LINK__COLLISION,
				 UrdfFactory.eINSTANCE.createCollision()));
	}
