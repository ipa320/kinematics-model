...
/**
 * This is the item provider adapter for a {@link urdf.Robot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RobotItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UrdfPackage.Literals.ROBOT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UrdfPackage.Literals.ROBOT__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UrdfPackage.Literals.ROBOT__JOINT);
			childrenFeatures.add(UrdfPackage.Literals.ROBOT__LINK);
			childrenFeatures.add(UrdfPackage.Literals.ROBOT__MATERIAL);
			childrenFeatures.add(UrdfPackage.Literals.ROBOT__TRANSMISSION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UrdfPackage.Literals.ROBOT__MATERIAL,
				 UrdfFactory.eINSTANCE.createMaterialGlobal()));

		newChildDescriptors.add
			(createChildParameter
				(UrdfPackage.Literals.ROBOT__TRANSMISSION,
