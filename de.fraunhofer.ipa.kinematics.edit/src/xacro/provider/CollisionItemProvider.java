...
/**
 * This is the item provider adapter for a {@link xacro.Collision} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollisionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Collision_geometry_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Collision_geometry_feature", "_UI_Collision_type"),
				 XacroPackage.Literals.COLLISION__GEOMETRY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XacroPackage.Literals.COLLISION__ORIGIN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XacroPackage.Literals.COLLISION__ORIGIN,
