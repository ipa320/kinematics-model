...
/**
 * This is the item provider adapter for a {@link xacro.Joint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JointItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XacroPackage.Literals.JOINT__PARENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XacroPackage.Literals.JOINT__CHILD,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XacroPackage.Literals.JOINT__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XacroPackage.Literals.JOINT__NAME);
			childrenFeatures.add(XacroPackage.Literals.JOINT__ORIGIN);
			childrenFeatures.add(XacroPackage.Literals.JOINT__AXIS);
			childrenFeatures.add(XacroPackage.Literals.JOINT__LIMIT);
		}
	...
	public String getText(Object object) {
		String label = ((Joint)object).getType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XacroPackage.Literals.JOINT__AXIS,
				 XacroFactory.eINSTANCE.createVector3()));

		newChildDescriptors.add
			(createChildParameter
				(XacroPackage.Literals.JOINT__LIMIT,
				 XacroFactory.eINSTANCE.createLimit()));
	}
