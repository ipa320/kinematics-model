		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ParameterValue_ref_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ParameterValue_ref_feature", "_UI_ParameterValue_type"),
				 XacroPackage.Literals.PARAMETER_VALUE__REF,
				 true,
				 false,
				 true,
				 null,
