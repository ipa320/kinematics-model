...
public class KinematicsParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, KinematicsGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRobotAccess().getGroup_5_3(), "rule__Robot__Group_5_3__0");
			...
			builder.put(grammarAccess.getRobotAccess().getRoot_linkAssignment_4_1(), "rule__Robot__Root_linkAssignment_4_1");
			builder.put(grammarAccess.getRobotAccess().getJointsAssignment_5_2(), "rule__Robot__JointsAssignment_5_2");
			builder.put(grammarAccess.getRobotAccess().getJointsAssignment_5_3_1(), "rule__Robot__JointsAssignment_5_3_1");
