 ...
 * </p>
 * <ul>
 *   <li>{@link urdf.impl.BoxImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoxImpl extends MinimalEObjectImpl.Container implements Box {
	...
	public void setSize(String newSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UrdfPackage.BOX__SIZE, oldSize, size, !oldSizeESet));
	}
	...
	public void unsetSize() {
		...
		sizeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, UrdfPackage.BOX__SIZE, oldSize, SIZE_EDEFAULT, oldSizeESet));
	}
