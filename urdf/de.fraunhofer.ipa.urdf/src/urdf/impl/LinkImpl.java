 ...
 * </p>
 * <ul>
 *   <li>{@link urdf.impl.LinkImpl#getInertial <em>Inertial</em>}</li>
 *   <li>{@link urdf.impl.LinkImpl#getVisual <em>Visual</em>}</li>
 *   <li>{@link urdf.impl.LinkImpl#getCollision <em>Collision</em>}</li>
 *   <li>{@link urdf.impl.LinkImpl#getName <em>Name</em>}</li>
 *   <li>{@link urdf.impl.LinkImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
	...
	public NotificationChain basicSetVisual(Visual newVisual, NotificationChain msgs) {
		...
		visual = newVisual;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UrdfPackage.LINK__VISUAL, oldVisual, newVisual);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVisual(Visual newVisual) {
		if (newVisual != visual) {
			NotificationChain msgs = null;
			if (visual != null)
				msgs = ((InternalEObject)visual).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UrdfPackage.LINK__VISUAL, null, msgs);
			if (newVisual != null)
				msgs = ((InternalEObject)newVisual).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UrdfPackage.LINK__VISUAL, null, msgs);
			msgs = basicSetVisual(newVisual, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UrdfPackage.LINK__VISUAL, newVisual, newVisual));
	}
	...
	public NotificationChain basicSetCollision(Collision newCollision, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UrdfPackage.LINK__COLLISION, oldCollision, newCollision);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCollision(Collision newCollision) {
		if (newCollision != collision) {
			NotificationChain msgs = null;
			if (collision != null)
				msgs = ((InternalEObject)collision).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UrdfPackage.LINK__COLLISION, null, msgs);
			if (newCollision != null)
				msgs = ((InternalEObject)newCollision).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UrdfPackage.LINK__COLLISION, null, msgs);
			msgs = basicSetCollision(newCollision, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UrdfPackage.LINK__COLLISION, newCollision, newCollision));
	}
