...
/**
 * This is the item provider adapter for a {@link urdf.Axis} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AxisItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Axis_xyz_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Axis_xyz_feature", "_UI_Axis_type"),
				 UrdfPackage.Literals.AXIS__XYZ,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Axis)object).getXyz();
