...
import de.fraunhofer.ipa.ide.contentassist.antlr.internal.InternalUrdfParser;
import de.fraunhofer.ipa.services.UrdfGrammarAccess;
import java.util.Map;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class UrdfParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(UrdfGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, UrdfGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getEStringAccess().getAlternatives(), "rule__EString__Alternatives");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup(), "rule__RobotType__Group__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_4(), "rule__RobotType__Group_4__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_5(), "rule__RobotType__Group_5__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_5_3(), "rule__RobotType__Group_5_3__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_6(), "rule__RobotType__Group_6__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_6_3(), "rule__RobotType__Group_6_3__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_7(), "rule__RobotType__Group_7__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_7_3(), "rule__RobotType__Group_7_3__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_8(), "rule__RobotType__Group_8__0");
			builder.put(grammarAccess.getRobotTypeAccess().getGroup_8_3(), "rule__RobotType__Group_8_3__0");
			...
			builder.put(grammarAccess.getRobotTypeAccess().getTransmissionAssignment_8_3_1(), "rule__RobotType__TransmissionAssignment_8_3_1");
			...
			builder.put(grammarAccess.getJointAccess().getOriginAssignment_6_1(), "rule__Joint__OriginAssignment_6_1");
			builder.put(grammarAccess.getJointAccess().getParentAssignment_8(), "rule__Joint__ParentAssignment_8");
			builder.put(grammarAccess.getJointAccess().getChildAssignment_10(), "rule__Joint__ChildAssignment_10");
	...
	@Override
	protected InternalUrdfParser createParser() {
		InternalUrdfParser result = new InternalUrdfParser(null);
